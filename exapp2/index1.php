...
<a href="#bio"><button type="button" class="gnav-login-button"><img src="images/biology.png" width="90px" height="60px"/> </button></a>&nbsp;&nbsp;
...
include('dbcon.php');
    ...
    $query=mysqli_query($conn, "SELECT * FROM chmg ORDER BY RAND() LIMIT 40")or die(mysqli_error($conn));
...
include('dbcon.php');
    ...
    $query=mysqli_query($conn, "SELECT * FROM biof ORDER BY RAND() LIMIT 40")or die(mysqli_error($conn));
...
<a href="#bio"><button type="button" class="gnav-login-button"><img src="images/rbiology.png" width="90px" height="60px"/></button></a>&nbsp;&nbsp;
